...
describe "BeermappingApi" do
  describe "in case of cache miss" do
    ...
    it "When HTTP GET returns no entry, it is parsed and returned" do
      ...
      stub_request(:get, /.*kalakala/).to_return(body: canned_answer, headers: {'Content-Type' => "text/xml"})

      places = BeermappingApi.places_in("kalakala")
    ...
    it "When HTTP GET returns multiple entries, they are parsed and returned" do
      ...
      expect(place.street).to eq("Tarkk'ampujankatu 20")
    end
  end
